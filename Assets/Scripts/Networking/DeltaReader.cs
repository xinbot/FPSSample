...
namespace Networking
{
    public struct DeltaReader
    {
        ...
        public static unsafe int Read<TInputStream>(ref TInputStream input, NetworkSchema schema, uint[] outputData,
            ...
            where TInputStream : IInputStream
        {
            ...
            for (int i = 0; i < numFields; ++i)
            {
                ...
                byte fieldBitOffset = (byte) ((uint) i & 0x7); // 0x7 = 0111
                ...
                switch (field.FieldType)
                {
                    ...
                    case FieldType.ByteArray:
                    {
                        ...
                        if (!masked)
                        {
                            // TODO (hash strings and bytearrays as well)
                            hash += 0;
                        }
